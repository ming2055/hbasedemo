...
public class JudgePointInPolygonArea {
    /**
     * 判断该地理坐标是否在最大范围区域内, 即根据顶点确定一个矩形区域
     *
    ...
    public static void main(String[] args) {
        double[] lon = new double[]{29.543324,
                29.542735,
                29.530980,
                29.541609
        };

        double[] lat = new double[] {106.498785,
                106.515646,
                106.496476,
                106.480200
        };

        double pointLon = 29.525909;
        double pointLat = 106.557274;

        System.out.println(isInAccurateArea(pointLon, pointLat, lon, lat));
    }
